    ...
    private var editMessageContent: some View {
        HStack(alignment: .center) {
            ...
            Button(action: {
                ...
                Image(systemName: config.images.crossIconName)
            ...
            Button(action: {
                ...
                Image(systemName: config.images.checkmarkIconName)
                    .foregroundColor(.white)
                    .frame(width: 30, height: 30)
    ...
    private func editedMessageContextMenu(for message: String) -> some View {
        Group {
            Button(action: {
                ...
                Image(systemName: config.images.replyIconName)
            })
            .disabled(true)
            ...
            Button(action: {
                ...
                Image(systemName: config.images.copyIconName)
            })
            ...
            Button(action: {
                ...
                Image(systemName: config.images.moreIconName)
            })
        }
    }
}
